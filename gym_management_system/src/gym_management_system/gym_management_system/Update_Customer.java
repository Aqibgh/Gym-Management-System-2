...
public class Update_Customer extends JFrame implements ActionListener
{
    ...
    Update_Customer()
    {
        ...
        setLocation(10,10);
        setResizable(false);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("gym_management_system/trainer5.jpg"));
        ...
        try {
            ...
            if (e.getSource() == bt1) {
                ...
                if (name.isEmpty() || fname.isEmpty() || email.isEmpty() || address.isEmpty() ||
                    cont.isEmpty() || tname.isEmpty() || heightText.isEmpty() ||
                ...
                String q = "UPDATE add_customer SET name='" + name + "', fname='" + fname + "', email='" + email +
                        "', address='" + address + "', contactNo='" + cont + "', payments_plan='" + minag +
                        "', gender='" + gender + "', height='" + height + "', weight='" + weight +
                        "', remarks='" + remarks + "', trainer_name='" + tname + "', category='" + tcat +
                        "' WHERE id='" + tid + "'";
