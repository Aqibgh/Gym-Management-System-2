    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bt1) {
            ...
            if (name.isEmpty() || fname.isEmpty() || email.isEmpty() || address.isEmpty() ||
                cont.isEmpty() || eno.isEmpty() || tidText.isEmpty() || heightText.isEmpty() ||
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Please enter valid numeric values for Trainer ID, Height, and Weight.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "An error occurred while inserting data: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                ex.printStackTrace();
            }
