        ...
        try {
            ...
            if (e.getSource() == bt1) {
                ...
                if (name.isEmpty() || fname.isEmpty() || email.isEmpty() || address.isEmpty() ||
                    cont.isEmpty() || eno.isEmpty() || heightText.isEmpty() ||
                    weightText.isEmpty() || remarks.isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Please fill in all fields.", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                // Validate Contact no. and Emergency no.
                if (!cont.matches("\\d+") || !eno.matches("\\d+")) {
                    JOptionPane.showMessageDialog(null, "Contact number and Emergency number must contain only numeric values.", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                String q = "UPDATE add_trainer SET name='" + name + "', fname='" + fname + "', email='" + email +
                        "', address='" + address + "', contactNo='" + cont + "', emergencyNo='" + eno +
                        "', category='" + tcat + "', min_aggrement='" + minag + "', gender='" + gender +
                        "', height='" + height + "', weight='" + weight + "', remarks='" + remarks +
                        "' WHERE tid='" + tid + "'";
